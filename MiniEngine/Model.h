...
struct ModelInitData {
	...
	void* m_expandConstantBuffer[3] = { nullptr };					//ユーザー拡張の定数バッファ。
	int m_expandConstantBufferSize[3] = {0};						//ユーザー拡張の定数バッファのサイズ。
	IShaderResource* m_expandShaderResourceView[MAX_MODEL_EXPAND_SRV] = { nullptr };
