...
private:
	...
	IShaderResource* m_expandShaderResourceView[MAX_MODEL_EXPAND_SRV] = { nullptr };	//ユーザー拡張シェーダーリソースビュー。
	...
	void* m_expandData[3] = { nullptr };						//ユーザー拡張データ。
};